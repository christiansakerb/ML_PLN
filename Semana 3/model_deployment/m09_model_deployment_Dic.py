...
def predict_price(Year,Mileage,State,Make,Model):
    ...
    scalers = joblib.load(os.path.dirname(__file__) + '/Dic_scalers.pkl') 
    ...
    #Carga de predictores:
    predictor_a_utilizar=joblib.load(os.path.dirname(__file__) + '/Dic_Predictores.pkl') 
